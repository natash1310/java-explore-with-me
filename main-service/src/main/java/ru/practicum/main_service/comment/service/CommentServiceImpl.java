...
import ru.practicum.main_service.comment.Comment;
import ru.practicum.main_service.comment.CommentMapper;
...
public class CommentServiceImpl implements CommentService {
    ...
    public CommentDto createByPrivate(Long userId, Long eventId, NewCommentDto newCommentDto) {
        ...
        if (!event.getState().equals(EventState.PUBLISHED)) {
            throw new DataIntegrityViolationException("Создавать комментарии можно только к опубликованным событиям.");
        }
